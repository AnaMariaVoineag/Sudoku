...
QtObject {
    ...
    readonly property double    h3 : 18.70
    ...
    readonly property var fontAwesomeBrand: FontLoader {
        source: "qrc:/UI/fonts/Font Awesome 5 Brands-Regular-400.otf"
    }

    readonly property var fontAwesomeRegular: FontLoader {
        source: "qrc:/UI/fonts/Font Awesome 5 Pro-Regular-400.otf"
    }

    readonly property var fontAwesomeLight: FontLoader {
        source: "qrc:/UI/fonts/Font Awesome 5 Pro-Light-300.otf"
    }

    readonly property var fontAwesomeSolid: FontLoader {
        source: "qrc:/UI/fonts/Font Awesome 5 Pro-Solid-900.otf"
    }

    readonly property var contentFontLight: FontLoader {
        source: "qrc:/UI/fonts/Nunito-Light.ttf"
    }

    readonly property var contentFontBold: FontLoader {
        source: "qrc:/UI/fonts/Nunito-Bold.ttf"
    }

    readonly property var contentFontMedium: FontLoader {
        source: "qrc:/UI/fonts/Nunito-Medium.ttf"
    }
}
